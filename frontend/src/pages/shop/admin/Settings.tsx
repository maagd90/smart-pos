      ...
      <div style={styles.section}>
        ...
        <div style={styles.card}>
          <div style={styles.field}>
            ...
            <input style={styles.input} placeholder="My Shop" />
          </div>
          <div style={styles.field}>
            <label style={styles.label}>Contact Email</label>
            <input style={styles.input} type="email" placeholder="shop@example.com" />
          </div>
          <div style={styles.field}>
            <label style={styles.label}>Tax Rate (%)</label>
            <input style={styles.input} type="number" step="0.01" placeholder="10" />
          </div>
          <div style={styles.field}>
