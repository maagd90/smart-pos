...
function App() {
  return (
    <main style={{ fontFamily: 'Arial, sans-serif', padding: 32 }}>
      ...
      <p>Web client skeleton. Auth and RBAC screens will be implemented after Identity & Tenant services.</p>
    </main>
  );
}
  ...
  return (
    <SafeAreaView>
      <View style={{ padding: 24 }}>
        <Text style={{ fontSize: 24, fontWeight: '700' }}>Store Management Mobile</Text>
        <Text>Inventory manager and store manager flows will be implemented after core services.</Text>
      </View>
    </SafeAreaView>
  );
}
