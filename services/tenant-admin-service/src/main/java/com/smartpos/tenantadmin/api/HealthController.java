package com.smartpos.tenantadmin.api;
...
/**
 * Health check endpoint for the Tenant and Admin Service.
 *
...
public class HealthController {
    ...
    public HealthResponse health() {
        return HealthResponse.up("tenant-admin-service", "0.1.0-SNAPSHOT");
    }
}
