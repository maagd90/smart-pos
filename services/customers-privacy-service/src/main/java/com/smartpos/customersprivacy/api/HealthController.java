package com.smartpos.customersprivacy.api;
...
/**
 * Health check endpoint for the Customers and Privacy Service.
 *
...
public class HealthController {
    ...
    public HealthResponse health() {
        return HealthResponse.up("customers-privacy-service", "0.1.0-SNAPSHOT");
    }
}
