...
/**
 * Scheduled task that polls unpublished outbox events and relays them to Kafka.
 *
 * <p>This ensures at-least-once delivery: the event is only marked published
 * after successful Kafka send.</p>
 */
@Component
