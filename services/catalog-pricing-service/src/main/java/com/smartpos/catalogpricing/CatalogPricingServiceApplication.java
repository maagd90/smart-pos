package com.smartpos.catalogpricing;

import org.springframework.boot.SpringApplication;
import org.springframework.boot.autoconfigure.SpringBootApplication;

/**
 * Catalog and Pricing Service microservice application.
 *
...
public class CatalogPricingServiceApplication {
    ...
    public static void main(String[] args) {
        SpringApplication.run(CatalogPricingServiceApplication.class, args);
    }
}
