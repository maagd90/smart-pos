package com.smartpos.catalogpricing.api;
...
/**
 * Health check endpoint for the Catalog and Pricing Service.
 *
...
public class HealthController {
    ...
    public HealthResponse health() {
        return HealthResponse.up("catalog-pricing-service", "0.1.0-SNAPSHOT");
    }
}
