package com.smartpos.messagingdelivery.api;
...
/**
 * Health check endpoint for the Messaging and Delivery Service.
 *
...
public class HealthController {
    ...
    public HealthResponse health() {
        return HealthResponse.up("messaging-delivery-service", "0.1.0-SNAPSHOT");
    }
}
